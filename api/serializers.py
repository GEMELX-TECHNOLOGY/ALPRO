...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = Usuarios
        fields = ['id', "email", "username", "password", "rol", "date_joined"]
...
class EmpleadosGetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Empleados
        fields = ['id','nombre', 'apellido_pa', "apellido_ma", "rfc", "calle", "numero_ext", "numero_int", 'cod_Postal', "estado", 'pais', 'user', 'horario', 'nomina', 'profile_image']
